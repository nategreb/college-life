"""Form tests for the ``reviews`` app."""
...
class ReviewFormTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.rating_category = mixer.blend('reviews.RatingCategoryTranslation',
    ...
    def test_form(self):
        ...
        self.assertEqual(Review.objects.count(), 1, msg=(
            'One reviews should have been created.'))
        self.assertEqual(
            Rating.objects.all()[0].review,
            Review.objects.all()[0],
            msg=('The rating\'s reviews should be equal the form\'s instance.'))
        self.assertEqual(
        ...
        self.assertEqual(Review.objects.count(), 2, msg=(
            'Another reviews should have been created.'))
        self.assertIsNotNone(review.user, msg=('User should be existant.'))

        self.new_category = mixer.blend('reviews.RatingCategoryTranslation',
                                        language_code='en-us')
    ...
    def test_form_with_custom_choices(self):
        ...
        for j in range(1, 4):
            ...
            choices.append(mixer.blend(
                'reviews.RatingCategoryChoiceTranslation',
        ...
        self.assertEqual(Rating.objects.all()[0].value, '3', msg=(
            'The rating\'s value should be saved.'))
        self.assertIsNone(reviews.user, msg=('User should be None.'))
