# Generated by Django 4.0.4 on 2022-12-08 02:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('colleges', '0004_professor_grading_difficulty_professor_personality_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('take_again', models.PositiveSmallIntegerField()),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colleges.collegeclasses')),
                ('term', models.ManyToManyField(to='colleges.semesteryear')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
