# Generated by Django 4.0.4 on 2022-12-15 16:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term', models.ManyToManyField(to='colleges.semesteryear')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(('grading_difficulty__isnull', False), ('grading_difficulty__range', (1, 5)),
                               ('personality__range', (1, 5)), ('take_again__isnull', False),
                               ('take_again__range', (1, 5)), ('teaching_quality__isnull', False),
                               ('teaching_quality__range', (1, 5))), name='check_professor_review'),
        ),
        migrations.AddConstraint(
            model_name='coursereview',
            constraint=models.CheckConstraint(
                check=models.Q(('take_again__isnull', False), ('take_again__range', (1, 5)),
                               ('test_heavy__isnull', False), ('test_heavy__range', (1, 5)),
                               ('theoretical__isnull', False), ('theoretical__range', (1, 5)),
                               ('usefulness__isnull', False), ('usefulness__range', (1, 5))), name='check_review'),
        ),
        migrations.AddConstraint(
            model_name='coursereview',
